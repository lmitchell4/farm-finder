...
@app.route("/farms/<int:farm_id>/JSON")
...
@app.route("/farms/<int:farm_id>/catalog/JSON")
...
@app.route("/farms/<int:farm_id>/catalog/<int:menu_id>/JSON")
...
@app.route("/farms/<int:farm_id>/events/JSON")
...
@app.route("/farms/<int:farm_id>/events/<int:event_id>/JSON")
